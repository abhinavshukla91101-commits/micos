...
"""
MiniOS Shell
The entire "desktop" is a bottom launcher bar with exactly three buttons:
Settings, Browser, Task Manager. No taskbar clutter, no start menu.
Runs as the Openbox autostart app; stays always-on-top, docked to bottom.
"""
import gi
